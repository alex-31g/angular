...
- **set** - добавить/изменить свойство для immutable объекта, созданного с помощью Map   
...
- **setIn** - добавить/изменить вложенное свойство для immutable объекта, созданного с помощью fromJS           
